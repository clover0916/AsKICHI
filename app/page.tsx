...
export default function Index() {
  ...
  return (
    <div className="Display w-[1920px] h-[1080px] relative">
      ...
      />
      <div className="information left-0 bottom-[270px] absolute p-8 pr-16 flex flex-col">
      ...
      <div className="Congestion w-[480px] h-[756px] px-8 pb-8 left-[1440px] top-[324px] absolute flex-col items-start gap-4 inline-flex bg-slate-900">
        {newEvents &&
          newEvents.map((event) => (
            <Group
              key={event.id}
